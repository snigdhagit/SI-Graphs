...
from .Utils.base import target_query_Interactspec
...
class grid_inference(object):
    ...
    def __init__(self,
        ...
        _scale = 6. * np.sqrt(np.diag(TS.cov_target))
    ...
    def _construct_density(self):
        ...
        for m in range(self.ntarget):
            ...
            bias_target = cov_target_uni.dot(U1.T.dot(-U4.dot(observed_target_uni) + QS.M1.dot(QS.opt_linear.dot(QS.cond_mean))) - _P)
